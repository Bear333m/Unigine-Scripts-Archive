...
{
    internal class TextCalloutCameraCreate
    {
        public void TextCalloutCamera(vec3 start, vec3 end, string text, int size, vec4 color, int background, vec4 backgroundColor) 
        {
