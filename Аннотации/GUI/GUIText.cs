...
namespace UnigineApp.data.Code.Annotation.GUI
{
    internal class GUIText
    {
        ...
        string[] NameMaterial = ["TextCalloutScen", "TextCalloutCamera", "TextScen", "TextCamera"];
        public void Text()
        {
            //var GUI = Gui.GetCurrent();
            var dialog = new EngineWindowViewport("Текст", 600, 700);
            ...
            foreach (var name in NameMaterial)
            {
                ...
                widgetSprite.Texture = "../data/UI/icon/Text_icon/" + name + ".png";
